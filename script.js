...
function determineFinalOutcome() {
    ...
    if (totalScore >= 10) {
        outcome = "The Crimson Tyrant: You have ruled with an iron fist...";
    } else if (totalScore >= 5) {
        outcome = "The Kingdom of Ash: You won. The enemies who sought to destroy you are no more...";
    } else {
        outcome = "The Hollow Throne: Your reign has ended, not with a bang...";
    }
