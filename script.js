...
function ending(selfishness, greed, morality){
    ...
    } else if ((totalScore >= -5 && totalScore <0) || (totalScore > 0 && totalScore < 5)) {
...
function determineFinalOutcome() {
    ...
    window.alert("Final PsychologicalProfile:\n\n" + finalProfile);
...
function determineFinalOutcome() {
    ...
    var finalProfile = getPsychologicalProfile(scoreSelfishness, scoreGreed, scoreMorality);
    window.alert("Ending:\n\n" + outcome);
    window.alert("Your Final Psychological Profile:\n\n" + finalProfile);
